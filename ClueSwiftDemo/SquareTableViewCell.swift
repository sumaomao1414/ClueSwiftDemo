...
//  ClueSwiftDemo
//
//  Created by maomao on 2017/11/2.
...
class SquareTableViewCell: UITableViewCell {
    ...
    func assignToViews(num:NSInteger) {
        ...
        //        清除之前添加的imageView
        _ = imageBackView.subviews.map {
            $0.removeFromSuperview()
        }
        
        //        for  item in images.subviews {
        ...
        let kWidth = (imageBackView.frame.size.width-kSpace*2)/3
        ...
        imageBackView.snp.updateConstraints { (ls) in
